...
export const GraphicView: React.FC = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    description: 'Logo moderne identité visuelle',
    dimensions: 'Vectoriel / Déclinaisons HD',
    fileFormat: 'PNG transparent, JPEG, PDF HD, SVG',
  ...
  const handleOpenAdd = () => {
    ...
    setFormData({
      ...
      description: 'Conception identité visuelle complète',
      dimensions: 'Vectoriel, 1080x1080px & print',
      fileFormat: 'PDF Haute Définition, PNG, SVG',
      graphicDesigner: 'Ange Koffi',
      price: 35000,
      advance: 20000,
      orderDate: new Date().toISOString().split('T')[0],
